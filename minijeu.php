...
<nav class="patate">
    <a href="http://localhost/"><input type="button" value="home"></a>
    <a href="http://localhost/minijeu.php"><input type="button" value="minijeu"></a>
    <a href="http://localhost/live.php"><input type="button" value="live"></a>
    <a href="http://localhost/contact.php"><input type="button" value="contact"></a>
    <a href="http://localhost/cute.php"><input type="button" value="cute"></a>
</nav>
